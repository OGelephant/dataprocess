...
# 读取数据
data = Dataset(r'C:\Users\Administrator\Desktop\Data_forcing_01dy_010deg\Data_forcing_01dy_010deg\temp_CMFD_V0106_B-01_01dy_010deg_200301-200312.nc')
...
df = pd.DataFrame({'Time': time_data, 'temperature': target_prec})

# 保存DataFrame到csv文件
output_file = 'CBStemperature2003.csv'
